...
export const data = [
        {
            ...
            "description":"This was one of my first projects using React. This app was built using Tailwind and the data is stored in the localStorage.",
        ...
        },
        {
            ...
            "description":"This project was my first approach to working with APIs. For this project I used Axios, a great tool to get data from API without too much effort.\nI also added a costume ErrorBoundary component to show up if something goes wrong.",
        ...
        },
        {
            ...
            "description":"This is a personal project that ais to help me to track my balance in a much better way and free, not having to pay anything to use all its features.\nRight now it is in progress as I am advancing some curses to certify myself, but I am working on it actively on weekends.",
            "skills":[ "javascript",
            "typescript",
            "next",
            "react",
